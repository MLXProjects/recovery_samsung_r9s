...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/r9s/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/r9s/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/r9s/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPUG16A001RU"
